...
#define PyxmlStreamReader_Get(v) (((v) == Py_None) ? NULL : \
        (((PyxmlStreamReader_Object *)(v))->obj))

typedef struct {
    PyObject_HEAD
    xmlTextReaderPtr obj;
} PyxmlStreamReader_Object;

#define PyxmlStreamReaderLocator_Get(v) (((v) == Py_None) ? NULL : \
        (((PyxmlStreamReaderLocator_Object *)(v))->obj))

typedef struct {
    PyObject_HEAD
    xmlTextReaderLocatorPtr obj;
} PyxmlStreamReaderLocator_Object;
...
#endif /* LIBXML_REGEXP_ENABLED */
PyObject * libxml_xmlStreamReaderPtrWrap(xmlTextReaderPtr reader);
PyObject * libxml_xmlStreamReaderLocatorPtrWrap(xmlTextReaderLocatorPtr locator);
